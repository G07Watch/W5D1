...
def substrings(string)
  ...
  (0...string.length).each do |index_1|
    new_string = ""
    (index_1...string.length).each do |index_2|
      new_string += string[index_2]
      new_arr << new_string
    end
  end
  new_arr 
...
def doubler(array)
  doubled = []
  array.each {|number| doubled << number * 2 }
  doubled
end
...
def concatenate(strings)
  strings.my_inject {|new_string, string| new_string + string}
end